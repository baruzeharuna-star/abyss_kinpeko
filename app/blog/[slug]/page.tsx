          ...
          <div className="relative p-2 md:p-3 rounded-2xl shadow-2xl overflow-hidden card-hover group">
            ...
            <div className="relative z-10 p-4 md:p-12 lg:p-20">
              <article className="prose prose-lg max-w-none">
                {post.htmlContent ? (
                  <div
                    className="text-gray-700 leading-relaxed prose-headings:text-primary-900 prose-headings:font-bold prose-p:text-gray-700 prose-p:my-5 prose-a:text-primary-600 prose-a:no-underline hover:prose-a:underline [&_br]:block [&_br]:mt-2"
